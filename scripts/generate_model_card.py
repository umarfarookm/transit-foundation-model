"""Generate a HuggingFace model card (README.md) for UmarTransit-1B."""

from pathlib import Path

from scripts.config import PROJECT_ROOT, get_logger
...
def main() -> None:
    ...
    output_path = PROJECT_ROOT / "docs" / "MODEL_CARD.md"
    ...
    print(f"\nTo update HuggingFace, copy this file as README.md to your HF repo:")
    print(f"  huggingface-cli upload umarfarookm/UmarTransit-1B {output_path} README.md")
